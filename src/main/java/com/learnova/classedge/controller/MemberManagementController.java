...
public class MemberManagementController {
    ...
    // @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<String> assignProfessorRole(@RequestBody MemberRequestDto memberRequestDto,
        ...
        try {
            ...
            return new ResponseEntity<>("Error occurred while assigning 'PROFESSOR' role.",
                    HttpStatus.INTERNAL_SERVER_ERROR);
        }
